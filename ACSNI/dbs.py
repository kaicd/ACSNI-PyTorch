...
class AcsniResults:
    ...
    def __str__(self):
        ...
        return "ACSNI result with {} modules over {} bootstraps.".format(
            n_modules, n_boot
        )
    ...
    def get_explained_variation(self, t, c):
        ...
        for i in weights:
            ...
            if c == "character":
                ...
                sys.exit(
                    "Invalid value set for parameter -c. "
    ...
    def get_summary_stat_phenotype(self, t, c):
        ...
        qq = self.__lm_w[[0]].quantile([0.25, 0.75])
        q25 = qq.loc[0.25, 0]
        q75 = qq.loc[0.75, 0]
        ...
        print(
            "Statistics of variations in subprocesses explained by {}".format(self.__nm)
        )
